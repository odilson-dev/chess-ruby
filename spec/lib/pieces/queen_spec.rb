...
RSpec.describe Queen do
    ...
    describe "#allowed_moves" do
        ...
        context "When the position of the white queen is in the middle of the chessboard (eg: [4, 3]), and there is 1 black pawn on each diagonal row" do
            ...
            moves_allowed = [[1, 0], [2, 1], [3, 2], [2, 3], [3, 3], [4, 0], [4, 1], [4, 2], [4, 4], [5, 2], [5, 3], [5, 4], [6, 1], [6, 3], [6, 5], [7, 3], [7, 6]]
        ...
        context "When the position of the white queen is in the middle of the chessboard (eg: [4, 3]), and there is 1 white pawn on each diagonal row" do
        ...
        context "When the position of the white queen is in the middle and bottom of the chessboard (eg: [7, 3]), and there is 1 black pawn on each adjacent square" do
            let(:chessboard_3) { ChessBoard.new }
            before do
                ...
                chessboard_3.add(pawn_1)
                chessboard_3.add(pawn_2)
                chessboard_3.add(pawn_3)
                chessboard_3.add(pawn_4)
                chessboard_3.add(pawn_5)
            end

            let(:queen) { Queen.new([7, 3], "white", chessboard_3) }
            it "The allowed moves are empty" do
