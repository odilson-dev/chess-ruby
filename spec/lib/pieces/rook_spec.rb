...
RSpec.describe Rook do
    ...
    describe "#find_allowed_moves" do
        context "When the position of the rook is in the middle of the chessboard (eg: [5, 5])" do
            let(:rook) { Rook.new([3, 3], "White", "H") }
            moves_allowed = [[3, 0], [3, 1], [3, 2], [3, 4], [3, 5], [3, 6], [3, 6],
                            [3, 7], [0, 3], [1, 3] [2, 3], [4, 3], [5, 3], [6, 3], [7, 3]]
            it "The allowed moves are: [[3, 0], [3, 1], [3, 2], [3, 4], [3, 5], [3, 6], [3, 6], [3, 7], [0, 3], [1, 3] [2, 3], [4, 3], [5, 3], [6, 3], [7, 3]]" do
                expect(rook.find_allowed_moves).to be_same_as moves_allowed
            end
        end

        context "When the position of the rook is at the bottom of the chessboard(eg: [4, 1])" do
            let(:rook) { Rook.new([7, 4], "White", "H") }
            moves_allowed = [[7, 0], [7, 1], [7, 2], [7, 3], [7, 5], [7, 6],
                            [7, 7], [0, 4], [1, 4], [2, 4], [3, 4], [4, 4], [4, 5],
                            [4, 6]]
            it "The allowed moves are: [[7, 0], [7, 1], [7, 2], [7, 3], [7, 5], [7, 6],
            [7, 7], [0, 4], [1, 4], [2, 4], [3, 4], [4, 4], [4, 5], [4, 6]]" do
                expect(rook.find_allowed_moves).to be_same_as moves_allowed
            end
        end
