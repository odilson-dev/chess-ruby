...
RSpec.describe Rook do
    RSpec::Matchers.define :be_same_as do |second_array|
        match do |first_array|
          first_array.length == second_array.length ? first_array.map { |posxition| second_array.include? posxition }.all? : false
        end
      end
    describe "#find_allowed_moves" do
        context "When the posxition of the rook is in the middle of the chessboard (eg: [3, 3])" do
        ...
        context "When the posxition of the rook is at the bottom of the chessboard(eg: [7, 4])" do
        ...
        context "When the posxition of the king is at the corner of the chessboard (eg: [7, 7])" do
