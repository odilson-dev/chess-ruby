...
RSpec.describe Knight do
    ...
    describe "#find_allowed_moves" do
        context "When the position of the knight is in the middle of the chessboard (eg: [4, 3])" do
            ...
            moves_allowed = [[3,1], [2, 2], [5, 1], [6, 2], [2, 4], [2, 5], [6, 4], [6, 5]]
            it "The allowed moves are: [[3,1], [2, 2], [5, 1], [6, 2], [2, 4], [2, 5], [6, 4], [6, 5]]" do
                expect(knight.find_allowed_moves).to eq moves_allowed
            end
        end
