...
class Queen < Piece
    ...
    def attack_moves(the_chessboard = @the_chessboard)
        all_attacks = []
        diagonal_attacks = find_all_attacks_diagonally(the_chessboard)
        perpendicular_attacks = find_all_attacks_perpendicularly(the_chessboard)

        all_attacks.concat(diagonal_attacks)
        all_attacks.concat(perpendicular_attacks)
